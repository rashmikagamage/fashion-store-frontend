    ...
    <Grid container className={classes.root} spacing={2}>
      <Grid container className={classes.paper} justify="center" spacing={4}>       
       <Grid item className={classes.control}>
        <HoverImage src={img1} style={{cursor: "pointer", height: "200px"}} hoverSrc={img1hover} onClick={viewManager} />
        </Grid>
        <Grid item>
        <HoverImage src={img2} style={{cursor: "pointer", height: "200px", width: "200px"}} hoverSrc={img2hover} onClick={addCategory} />
        </Grid>
        <Grid item>
